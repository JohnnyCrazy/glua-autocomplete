...
module.exports = {
    ...
    activate: function() {
        console.log(getEditDistance("lel", "lel"))
        console.log(getEditDistance("SetPos", "SetPoseBla"))
    ...
    getSuggestions: function(arg) {
        ...
        var buildSnippet = function(func, text) {
            console.log(funcRegex);
            var match = text.match(funcRegex);
            console.log(match);
            return '';
        }
        console.log(buildSnippet("SetPos", text));
